...
export soft_fadd, soft_fsub, soft_fmul, soft_fma, soft_fdiv, soft_fsqrt, soft_fneg, soft_fcmp_olt, soft_fcmp_oeq, soft_fcmp_ole, soft_fcmp_une, soft_fptosi, soft_fptoui, soft_sitofp, soft_fpext, soft_fptrunc, soft_exp, soft_exp2, soft_exp_fast, soft_exp2_fast, soft_exp_julia, soft_exp2_julia, soft_log, soft_log2, soft_log10, soft_pow, soft_powi, soft_pow_julia, soft_sin, soft_cos, soft_tan, soft_atan, soft_atan2, soft_asin, soft_acos
...
Base.@kwdef struct CompileOptions
    ...
    # picks the impl (`:linear_scan` + `:okasaki` + `:hamt` wired post-
    # Bennett-d746; `:cf` in a follow-up bead); `hashcons` selects hash-
    # consing strategy (`:none` today; `:naive`/`:feistel` in follow-up beads).
    mem::Symbol = :auto
