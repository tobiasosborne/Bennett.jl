...
- Public min compilation confirmed F3 end to end: `reversible_compile(min,Float64,Float64)` maps `(0xfff8000000000123, bits(1.0))` to canonical `0x7ff8000000000000` while native returns `0xfff8000000000123`; reversibility passed. This reinforces that ancilla checks alone do not validate numerical semantics.
