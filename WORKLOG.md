...
|---|---:|---|
| [056_2026-05-03_37mt_memcpy_phase1.md](worklog/056_2026-05-03_37mt_memcpy_phase1.md) | ~280 | Session log — 2026-05-03 evening — **Bennett-9nwt close** (Bennett-hao Phase 2: const-c const-N memset on alloca-i8 dst, byte-granular IRStore-of-ConstOperand, 82 asserts) followed by **Bennett-37mt close** (Phase 1: const-size memcpy, byte-granular chunks, 80 asserts). Both ship via 3+1 protocol. Common gotcha: bead's "(N/8) at 64-bit granularity + memory.jl unchanged" wording is internally inconsistent (aggregate.jl:227 / memory.jl:245-246 force byte-granular on alloca-i8). |
