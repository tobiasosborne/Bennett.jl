; Bennett-lx5h: llvm.vector.reduce.fmax.v4f64.
; NaN-absorbing reduction (≡ maxNum / soft_fmax chain).

declare double @llvm.vector.reduce.fmax.v4f64(<4 x double>)

define i64 @lx5h_reduce_fmax_v4f64(i64 %a, i64 %b, i64 %c, i64 %d) {
entry:
  ...
  %r  = call double @llvm.vector.reduce.fmax.v4f64(<4 x double> %v3)
