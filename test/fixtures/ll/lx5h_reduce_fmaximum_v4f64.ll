; Bennett-lx5h: llvm.vector.reduce.fmaximum.v4f64.
; IEEE 754-2008 NaN-PROPAGATING reduction (≡ Base.max / soft_fmaximum chain).

declare double @llvm.vector.reduce.fmaximum.v4f64(<4 x double>)

define i64 @lx5h_reduce_fmaximum_v4f64(i64 %a, i64 %b, i64 %c, i64 %d) {
entry:
  ...
  %r  = call double @llvm.vector.reduce.fmaximum.v4f64(<4 x double> %v3)
