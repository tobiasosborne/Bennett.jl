; Bennett-lx5h: llvm.vector.reduce.fmin.v4f64.
; LLVM langref: NaN-absorbing reduction (≡ minNum / soft_fmin chain).
; No start value — single vector operand.

declare double @llvm.vector.reduce.fmin.v4f64(<4 x double>)

define i64 @lx5h_reduce_fmin_v4f64(i64 %a, i64 %b, i64 %c, i64 %d) {
entry:
  ...
  %r  = call double @llvm.vector.reduce.fmin.v4f64(<4 x double> %v3)
